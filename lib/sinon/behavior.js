...
function addBehaviorFake(stub, name, fn) {
    proto[name] = function () {
        fn.apply(this, concat([this], slice(arguments)));
        return this.stub || this;
    };
...
function addBehaviorAnotherFake(stub, name, fn) {
    proto[name] = function () {
        fn.apply(this, concat([this], slice(arguments)));
        return this.stub || this;
    };
...
function addBehaviorFake3(stub, name, fn) {
    proto[name] = function () {
        fn.apply(this, concat([this], slice(arguments)));
        return this.stub || this;
    };
...
function addBehaviorAnotherFake4(stub, name, fn) {
    proto[name] = function () {
        fn.apply(this, concat([this], slice(arguments)));
        return this.stub || this;
    };
...
proto.addBehavior = addBehaviorFake;
proto.addBehavior = addBehaviorAnotherFake;
proto.addBehavior = addBehaviorFake3;
proto.addBehavior = addBehaviorAnotherFake4;
